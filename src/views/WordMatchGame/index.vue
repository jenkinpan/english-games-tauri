    ...
    <div class="word-match-game-container">
        ...
        <header class="game-header">
            <div class="header-left">
                <router-link
                    to="/"
                    class="btn btn-secondary btn-sm back-home-link"
                >
                    ...
                    >
                        ...
                        <div class="category-content">
                            <transition-group name="fade">
                                <span
                                    v-for="w in getCompletedWordsForCategory(
                                        cat.id,
                                    )"
                                    :key="w.id"
                                    class="mini-word"
                    ...
                    <div class="word-editor" v-if="currentEditingGroup">
                        ...
                        <div class="categories-editor-list">
                            <div
                                v-for="(
                                    cat, cIdx
                                ) in currentEditingGroup.categories"
                                :key="cat.id"
                            ...
                            <div
                                v-if="
                                    currentEditingGroup.categories.length === 0
                                "
