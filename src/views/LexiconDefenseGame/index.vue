    ...
    <div class="lexicon-defense-container">
        ...
        >
            <div class="hud">
                ...
                <span
                    >护盾：<strong
                        :class="{ 'shield-damage': isShieldDamaged }"
                        >{{ shield }}</strong
                    ></span
                >
                <span
            ...
            <div class="editor-window">
                ...
                <div class="editor-footer">
                    ...
                    <div style="display: flex; gap: 10px">
                        <button class="secondary" @click="closeEditor">
                            取消
                        </button>
