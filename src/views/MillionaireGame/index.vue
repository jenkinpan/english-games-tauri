      ...
      <div class="game-container">
        ...
        <div class="control-panel">
              ...
              >
                ...
                <div class="player-info">
                  ...
                  <i
                    ...
                    style="color: var(--ctp-sapphire); margin-left: 8px; font-size: 0.9rem"
                    title="护盾保护中"
                  ></i>
                </div>
                <span style="margin-left: auto; font-size: 0.9rem; color: var(--ctp-subtext1)">
          ...
          <div class="panel-box">
            ...
            <p style="text-align: center; color: var(--ctp-subtext1); font-size: 0.9rem">
              {{ diceMsg }}
            </p>
          </div>
          ...
          <div class="panel-box log-panel-box">
            ...
            <div class="event-log">
              <div
                ...
                style="text-align: center; color: var(--ctp-overlay0); font-size: 0.85rem; margin-top: 8px"
              >
                暂无记录
              </div>
              <div
      ...
      <div class="modal-content" style="max-width: 900px; height: 600px">
        ...
        <div class="settings-layout">
          ...
          <div class="settings-main" v-if="currentGroup">
            <div class="questions-header">
              <div style="flex: 1; display: flex; align-items: center; gap: 15px">
                <input
                  ...
                  placeholder="分组名称"
                />
                <span style="color: var(--ctp-overlay1); font-size: 0.9rem; font-weight: bold; white-space: nowrap">
            ...
            <div class="questions-list">
              <div
                ...
                style="text-align: center; color: var(--ctp-overlay1); margin-top: 50px"
              >
                暂无题目，点击右上角添加
              </div>
              <div
                ...
                class="question-row"
              >
                <span style="font-weight: bold; color: var(--ctp-overlay1); padding-top: 5px">
                  {{ idx + 1 }}.
                </span>
          ...
          <div
            class="settings-main"
            v-else
            style="justify-content: center; align-items: center; color: var(--ctp-overlay1)"
          >
            请在左侧选择一个分组
          </div>
        </div>
    ...
    <div class="modal chest-scene-modal" :class="{ show: chestModal.show }">
      <div class="chest-scene">
          ...
          <div class="chests-row-new">
            ...
            >
              <div
                ...
                :style="{
                  background: ['var(--ctp-mauve)', 'var(--ctp-yellow)', 'var(--ctp-teal)'][idx],
                }"
              ></div>
              <div class="chest-svg-wrap">
                ...
                <svg v-if="idx === 0" width="180" height="194" viewBox="0 0 100 108" fill="none">
                  ...
                  <g
                    :class="{ 'chest-lid-open': selectedChest === 0 && chestPhase === 'pick' }"
                    style="transform-origin: 50px 52px; --lid-tx: -28px; --lid-ty: -20px; --lid-rot: -30deg"
                  >
                ...
                <svg v-else-if="idx === 1" width="220" height="234" viewBox="0 0 120 128" fill="none">
                  ...
                  <g
                    :class="{ 'chest-lid-open': selectedChest === 1 && chestPhase === 'pick' }"
                    style="transform-origin: 60px 62px; --lid-tx: 0px; --lid-ty: -26px; --lid-rot: 0deg"
                  >
                ...
                <svg v-else width="180" height="194" viewBox="0 0 100 108" fill="none">
                  <ellipse cx="50" cy="104" rx="32" ry="5" fill="var(--ctp-shadow, rgba(0,0,0,.45))"/>
                  <g
                    :class="{ 'chest-lid-open': selectedChest === 2 && chestPhase === 'pick' }"
                    style="transform-origin: 50px 52px; --lid-tx: 28px; --lid-ty: -20px; --lid-rot: 30deg"
                  >
              ...
              <div
                class="clabel-new"
                :style="{ color: ['var(--ctp-mauve)', 'var(--ctp-yellow)', 'var(--ctp-teal)'][idx] }"
              >
                {{ ['魔法宝箱', '黄金宝箱', '秘法宝箱'][idx] }}
              </div>
            </div>
        ...
        <div class="chest-screen" :class="{ 'chest-screen-hidden': chestPhase !== 'reward' }">
          <div v-if="chestReward" class="chest-reward-card"
            :style="{ '--rc-glow': 'color-mix(in srgb,' + chestReward.color + ' 22%,transparent)' }"
          >
            <div class="chest-rc-badge">{{ chestReward.icon }}</div>
            <div
              class="chest-rc-type"
              :style="{ background: chestReward.badgeBg, color: chestReward.badgeColor }"
            >
            ...
            <button
              ...
              :style="{ color: chestReward.color, borderColor: chestReward.color }"
    ...
    <div class="modal" :class="{ show: showDeleteGroupConfirm }">
      <div class="modal-content" style="max-width: 400px; text-align: center">
        ...
        <div style="display: flex; gap: 20px; justify-content: center; margin-top: 20px">
          <button class="btn btn-gray" @click="showDeleteGroupConfirm = false">取消</button>
          <button class="btn btn-red" @click="confirmDeleteGroup">确认删除</button>
        </div>
      </div>
    </div>
  </div>
